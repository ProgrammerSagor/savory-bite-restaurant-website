...
Route::get('/food-details/{id}/{slug}', [HomeController::class, 'food_details'])->name('food_details');

Route::post('/food/{id}/{slug}', [HomeController::class, 'submitReview'])->name('food_review');
