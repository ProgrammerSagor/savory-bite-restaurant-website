            ...
            <div class="relative z-10 text-white">
                <div
                    ...
                    <div class="mb-8 text-center">
                        <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Join Our Food Community</h2>
                        <p class="mt-2 text-gray-600 dark:text-gray-300">Create your account to unlock exclusive features</p>
                    </div>
                    ...
                    <form method="POST" class="space-y-6 " action="{{ route('register') }}">
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div>
                                ...
                                <input type="text" name="first_name" value="{{ old('first_name') }}"
                                    class="w-full px-4 py-3 text-gray-800 placeholder-gray-400 transition-all bg-white border border-gray-300 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
                        ...
                        <div class="flex items-start space-x-3">
                            <input type="checkbox" id="terms" name="agree_terms"
                                class="mt-1 border-gray-300 rounded focus:ring-primary text-primary dark:border-gray-600"
                                required>
                            <label for="terms" class="text-sm text-gray-600 dark:text-gray-400">
                                I agree to the <a href="#"
                                    class="font-medium text-primary hover:text-primary-dark">Terms
                    ...
                    <p class="mt-8 text-center text-gray-600 dark:text-gray-400">
                        ...
                        <a href="{{ route('login') }}" class="ml-1 font-semibold transition-colors text-primary hover:text-primary-dark">
